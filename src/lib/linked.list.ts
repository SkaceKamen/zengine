export class LinkedList<T extends IItem> {
	...
	protected start: InternalItem<T> = null;
	protected end: InternalItem<T> = null;
	 ...
	 */
	public each(callback: (value: T, item: InternalItem<T>, index: number) => boolean | void) {
...
export class Iterator<T extends IItem> {
